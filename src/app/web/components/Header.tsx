...
const Header = () => {
  ...
  return (
    <div className='w-full h-20 fixed top-0 border-b border-gray-900 '>
      <div className='w-full h-full absolute backdrop-blur-sm'></div>
      <div className='w-full h-full absolute z-10 flex items-center justify-between px-4 md:px-10 lg:px-40 xl:px-44'>
